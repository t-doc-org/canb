...
% print("Quel est l'âge de la première personne? ")
% age_1 = int(input())
% print("Quel est l'âge de la deuxième personne? ")
% age_2 = int(input())
%
% # Complétez le programme ici
% ```
...
print("Nombre de séances: ")
nb_seances = int(input())
...
print("Choisir un premier nombre: ")
nombre_1 = float(input())
print("Choisir un deuxième nombre: ")
nombre_2 = float(input())
print("Choisir un troisième nombre: ")
...
print("Coefficient de x^2: ")
a = float(input())
print("Coefficient de x: ")
b = float(input())
print("Coefficient sans partie littérale: ")
c = float(input())
...
Cette page a été reprise de ma collègue Caroline Blank et adaptée. 
